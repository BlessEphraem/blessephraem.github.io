...
### `theme_default`
![Default theme](/img/inputbar/preview_theme_default.png)

### `theme_catppuccin_latte`
![Catppuccin Latte](/img/inputbar/preview_theme_catppuccin_latte.png)

### `theme_catppuccin_mocha`
![Catppuccin Mocha](/img/inputbar/preview_theme_catppuccin_mocha.png)

### `theme_dracula`
![Dracula](/img/inputbar/preview_theme_dracula.png)

### `theme_gruvbox`
![Gruvbox](/img/inputbar/preview_theme_gruvbox.png)

### `theme_high_contrast`
![High Contrast](/img/inputbar/preview_theme_high_contrast.png)

### `theme_light`
![Light](/img/inputbar/preview_theme_light.png)

### `theme_material_palenight`
![Material Palenight](/img/inputbar/preview_theme_material_palenight.png)

### `theme_monokai`
![Monokai](/img/inputbar/preview_theme_monokai.png)

### `theme_nord`
![Nord](/img/inputbar/preview_theme_nord.png)

### `theme_solarized_dark`
![Solarized Dark](/img/inputbar/preview_theme_solarized_dark.png)

### `theme_solarized_light`
![Solarized Light](/img/inputbar/preview_theme_solarized_light.png)

### `theme_synthwave`
![Synthwave](/img/inputbar/preview_theme_synthwave.png)
